...
do
	...
	then
		...
		cp data/${origSub}/behav/labels/Run${r}.tsv data/${newSub}/func/${newSub}_task-${taskname}_${target}_events.tsv
		sed -e "s/Onset/onset/g" -e "s/Duration/duration/g" -e "s/Intensity/intensity/g" -i data/${newSub}/func/${newSub}_task-${taskname}_${target}_events.tsv
	fi
...
mv data/${origSub}/behav/labels derivatives/${newSub}/misc/
