...
userOptions.projectName  = 'Analogy';
...
% userOptions.rootPath='D:\fmri\Analogy\matlab';
userOptions.rootPath='/Volumes/fmri/Analogy/matlab';
...
userOptions.betaPath = fullfile(userOptions.rootPath,'[[subjectName]]','betas','[[subjectName]]_[[betaIdentifier]].nii.gz');% e.g. /imaging/mb01/lexpro/multivariate/ffx_simple/[[subjectName]]/[[betaIdentifier]]

userOptions.betaList = fullfile(userOptions.rootPath, 'AB_beta_list.csv');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
